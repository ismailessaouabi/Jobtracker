<div class=" bg-[#f6f6f8] pt-10 flex flex-col w-[80%] max-w-6xl px-4 md:px-10 flex-1">
    <!-- TopNavBar -->
    <header
        class="flex items-center justify-between whitespace-nowrap border-b border-solid border-gray-200  pb-4">
        <div class="flex items-center gap-4 text-[#1A202C] ">
            ...
            <h2
                class="text-[#1A202C]  text-lg font-bold leading-tight tracking-[-0.015em]">
                JobTrackr</h2>
        </div>
        <div class="flex flex-1 justify-end items-center gap-4">
            ...
            <div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10"
                ...
                style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuD8uNh4IESqWnhTfEUgicSWxJ7HSITgx7lp2i_sfUP4QRV7GxKRr2DimrsFhIEasXhsyktDbALfAQscOapq2DxsWwNkmdNRhyaLf5l-3cuGQ28R3V74oIXAZH1fplEuvr6xp5cqk2oGU8ffDPbYPAjnl-uCKT1AwO_Gcosmmh3q_WgdwUM495UmpdcpKI6qMTXyKhGsJAXxvcDZnMbgof3CvyAuoXktGFx3w5KWTZl9iWjjqiDmACSbGUoJSYoZDhHN_xP89mhicPbz");'>
            </div>
        </div>
    </header>
    <main class="mt-8">
        ...
        <div class="flex flex-wrap justify-between gap-3 p-4">
            <div class="flex min-w-72 flex-col gap-2">
                <p
                    class="text-[#1A202C]  text-4xl font-black leading-tight tracking-[-0.033em]">
                    Mes Candidatures</p>
                <p class="text-[#718096] 0 text-base font-normal leading-normal">Suivez
                    et gérez toutes vos candidatures en un seul endroit.</p>
            </div>
        </div>
        <!-- ToolBar and Chips -->
        <div
